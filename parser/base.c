    ...
    while (0 <= (scanner_status = zephir_get_token(state, &token))) {
        ...
        switch (token.opcode) {
            ...
            case ZEPHIR_T_INLINE:
                ...
                break;
            case ZEPHIR_T_DEPRECATED:
                zephir_(zephir_parser, ZEPHIR_DEPRECATED, NULL, parser_status);
                break;
            case ZEPHIR_T_FINAL:
            ...
            case ZEPHIR_T_ELSE:
                ...
                break;
            case ZEPHIR_T_ELSEIF:
                zephir_(zephir_parser, ZEPHIR_ELSEIF, NULL, parser_status);
                break;
            case ZEPHIR_T_LOOP:
